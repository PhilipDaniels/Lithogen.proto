...
{
    public class MemoryFileSystem_CreateDirectory : IFileSystem_CreateDirectory<MemoryFileSystem>
    {
    }

    public class MemoryFileSystem_CreateParentDirectory : IFileSystem_CreateParentDirectory<MemoryFileSystem>
    {
    }
    ...
    public class MemoryFileSystem_DeleteFile : IFileSystem_DeleteFile<MemoryFileSystem>
    {
    }
